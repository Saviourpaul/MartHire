<x-layout>
    ...
    <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        ...
        @endif
        <!-- DataTable -->
        <div data-table-refresh-region data-table-refresh-id="admin-employers" class="overflow-hidden rounded-xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
