...
<head>
  ...
  <title>Login — MartHire</title>
<meta name="title" content="Login — MartHire">
...
<link rel="canonical" href="https://marthire.com/login">
...
<meta property="og:url" content="https://marthire.com/login">
<meta property="og:title" content="Login — MartHire">
...
<meta name="twitter:title" content="Login — MartHire">
            ...
            <div>
                ...
                <div class="space-y-5">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}"
                      class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">Forgot password?</a>
                  </div>
                  <!-- Button -->
                  <div>
                    <button
              ...
              <div class="mt-5">
                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                  ...
                  <a href="{{ route('register') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Register</a>
                </p>
              </div>
            </div>
          </div>
