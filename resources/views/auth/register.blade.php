...
<head>
    ...
    <title>Create an Account — MartHire</title>
    <meta name="title" content="Create an Account — MartHire">
    <meta name="description"
        content="Create a Your MartHire account as a candidate, employer, or recruiter and start managing recruitment the structured way.">

    <link rel="canonical" href="https://marthire.com/register">

    <meta name="robots" content="noindex, nofollow">

    <meta property="og:type" content="website">
    <meta property="og:url" content="https://marthire.com/register">
    <meta property="og:title" content="Create an Account — MartHire">
    <meta property="og:description"
        content="Register up as a candidate, employer, or recruiter and start using MartHire's recruitment management platform.">
    <meta property="og:image" content="https://marthire.com/og-image.png">
    <meta property="og:site_name" content="MartHire">

    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Create an Account — MartHire">
...
<body x-data="{ page: 'comingSoon', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode')) ?? false;
                    ...
                    <div>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                ...
                                <a href="{{ route('login') }}"
                                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">login</a>
                            </p>
                        </div>
                    </div>
                </div>
